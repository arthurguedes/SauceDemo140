...
import pytest    #framework do teste de unidade                   
import time
import json
...
class TestSelecionarProduto():
  def setup_method(self, method):
    ...
    self.vars = {}
    self.driver.implicitly_wait(5)    #espera por qualquer elemento por até 5 segundos 
  ...
  def test_selecionarProduto(self):
    ...
    self.driver.set_window_size(1250, 852)
    ...
    #time.sleep(3)     #parando a thread por dois segundos
