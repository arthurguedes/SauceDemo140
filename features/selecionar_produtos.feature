Feature: Selecionar Produto
    ...
    Scenario: Selecionar produto "Sauce Labs Backpack"
        ...
        When preencho os campos de login com usuario standard_user and senha secret_sauce
        Then sou direcionado para pagina Home 

    Scenario: Login com a senha invalida
        Given que acesso o site Sauce Demo 
        When preencho os campos de login com usuario standard_user and senha laranja
        Then exibe a mensagem de erro no login 

    Scenario Outline: Login Negativo
        Given que acesso o site Sauce Demo 
        When preencho os campos de login com usuario <usuario> and senha <senha>
        Then exibe a <mensagem> de erro no login
    ...
    Scenario Outline: Login Negativo com IF
        Given que acesso o site Sauce Demo 
        When digito os campos de login com usuario <usuario> and senha <senha> com IF
        Then exibe a <mensagem> de erro no login
